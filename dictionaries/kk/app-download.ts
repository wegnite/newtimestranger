export const appDownload = {
  meta: {
    title: "Digimon Story Time Stranger жүктеп алу - Жайлы бөлмені ұйымдастыру ойыны",
    description:
      "Digimon Story Time Stranger жүктеп алып, бөлмелерді ұйымдастыру және безендірудің жүрек жылытатын саяхатын бастаңыз. Саналы ұйымдастыру арқылы мінсіз өмір сүру кеңістігіңізді жасаңыз.",
  },
