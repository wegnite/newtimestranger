...
export const levelDetail = {
  ...
  meta: {
    title: `Nível {{level}} do Dreamy Room - Guia do Jogo e Passo a Passo - Dreamy Room Nível {{level}} & Dicas em Vídeo`,
    description: `Dreamy Room Nível {{level}}, Guia completo para o Nível {{level}} do Dreamy Room, fornecendo dicas detalhadas de organização, soluções de posicionamento de itens e passo a passo em vídeo. Ajuda você a completar facilmente o nível e criar o espaço perfeito e aconchegante.`,
  ...
  sidebar: {
    adjacentLevels: "Níveis Adjacentes",
    allLevels: "Todos os Níveis",
  },
  shareLabel: "Compartilhar Guia do Nível",
