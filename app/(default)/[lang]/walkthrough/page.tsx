...
export default async function WalkthroughIndex({
                                                   params: { lang },
                                               }: {
    params: { lang: Locale };
}) {
    ...
    const jsonLd = {
        ...
        url: `${process.env.NEXT_PUBLIC_SITE_URL}/${lang}/walkthrough`,
        keywords:
            "digimon story time stranger walkthrough, Digimon Story Time Stranger Walkthrough, digimon story time stranger main missions",
        about: {
            "@type": "VideoGame",
